...
class AppModuleInjector extends import0.NgModuleInjector<import1.AppModule> {
  ...
  __ErrorService_41:import27.ErrorService;
  __MessageService_42:import28.MessageService;
  ...
  __AuthService_53:import33.AuthService;
  ...
  get _XSRFStrategy_36():any {
    if ((this.__XSRFStrategy_36 == (null as any))) { (this.__XSRFStrategy_36 = import6._createDefaultCookieXSRFStrategy()); }
  ...
  get _Http_39():any {
    if ((this.__Http_39 == (null as any))) { (this.__Http_39 = import6.httpFactory(this._XHRBackend_37,this._RequestOptions_38)); }
  ...
  get _ErrorService_41():import27.ErrorService {
    if ((this.__ErrorService_41 == (null as any))) { (this.__ErrorService_41 = new import27.ErrorService()); }
    return this.__ErrorService_41;
  }
  get _MessageService_42():import28.MessageService {
    if ((this.__MessageService_42 == (null as any))) { (this.__MessageService_42 = new import28.MessageService(this._Http_39,this._ErrorService_41)); }
  ...
  get _LocationStrategy_44():any {
    if ((this.__LocationStrategy_44 == (null as any))) { (this.__LocationStrategy_44 = import5.provideLocationStrategy(this.parent.get(import43.PlatformLocation),this.parent.get(import44.APP_BASE_HREF,(null as any)),this._ROUTER_CONFIGURATION_43)); }
  ...
  get _Router_50():any {
    if ((this.__Router_50 == (null as any))) { (this.__Router_50 = import5.setupRouter(this._ApplicationRef_16,this._UrlSerializer_46,this._RouterOutletMap_47,this._Location_45,this,this._NgModuleFactoryLoader_48,this._Compiler_17,this._ROUTES_49,this._ROUTER_CONFIGURATION_43)); }
  ...
  get _AuthService_53():import33.AuthService {
    if ((this.__AuthService_53 == (null as any))) { (this.__AuthService_53 = new import33.AuthService(this._Http_39,this._ErrorService_41)); }
  ...
  createInternal():import1.AppModule {
    ...
    this._ApplicationRef__15 = new import13.ApplicationRef_(this.parent.get(import41.NgZone),this.parent.get(import48.Console),this,this._ErrorHandler_12,this,this._ApplicationInitStatus_13,this.parent.get(import12.TestabilityRegistry,(null as any)),this._Testability_14);
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import50.ErrorHandler)) { return this._ErrorHandler_12; }
    ...
    if ((token === import51.DOCUMENT)) { return this._DOCUMENT_19; }
    ...
    if ((token === import52.AnimationDriver)) { return this._AnimationDriver_24; }
    if ((token === import18.DomRootRenderer)) { return this._DomRootRenderer_25; }
    if ((token === import53.RootRenderer)) { return this._RootRenderer_26; }
    if ((token === import19.DomSanitizer)) { return this._DomSanitizer_27; }
    if ((token === import54.Sanitizer)) { return this._Sanitizer_28; }
    if ((token === import20.ViewUtils)) { return this._ViewUtils_29; }
    if ((token === import55.IterableDiffers)) { return this._IterableDiffers_30; }
    if ((token === import56.KeyValueDiffers)) { return this._KeyValueDiffers_31; }
    ...
    if ((token === import27.ErrorService)) { return this._ErrorService_41; }
    if ((token === import28.MessageService)) { return this._MessageService_42; }
    ...
    if ((token === import59.NgModuleFactoryLoader)) { return this._NgModuleFactoryLoader_48; }
    if ((token === import60.ROUTES)) { return this._ROUTES_49; }
    if ((token === import47.Router)) { return this._Router_50; }
    if ((token === import61.ActivatedRoute)) { return this._ActivatedRoute_51; }
    if ((token === import38.APP_BOOTSTRAP_LISTENER)) { return this._APP_BOOTSTRAP_LISTENER_52; }
    if ((token === import33.AuthService)) { return this._AuthService_53; }
